...
# and download them as images for Chabs skin top picks screen.
#
...
#          e.g. This script could be set to run every 15m, but ChabsScrape.sh would
...
# UNDO??   TOPPICKS IMAGE PICONS ARE HARDCODED IN THE SKYNEW SKINS... THIS MEANS:
...
sources_maxage="720"
# UNCOMMENT TO GET IMAGE LISTS FROM SERVER INSTEAD OF FROM SCRIPT CHABSCRAPE.SH
#sources_server="http://www.example.com/toppicks/lists/"

workdir="/usr/share/enigma2/scrapes"		# PREFER: /usr/share/enigma2/skyQ/Toppicks/scrapes
piconbase="/usr/share/enigma2/skyQ/SkyIcons/picons-base/"
piconpath="/usr/share/enigma2/skyQ/SkyIcons/picons/"
...
for image_no in 1 2 3 4 5 6 7 8; do
  ...
  case ${image_no} in
    1) resize=",w_800,h_450,c_fill,g_auto"; min_category="1"; max_category="1" ;;
    2) resize=",w_115,h_153,c_fill,g_auto";  min_category="2"; max_category="2" ;;
    3) resize=",w_115,h_153,c_fill,g_auto"; min_category="3"; max_category="3" ;;
    4) resize=",w_272,h_153,c_fill,g_auto"; min_category="4"; max_category="4" ;;
    5) resize=",w_272,h_153,c_fill,g_auto"; min_category="5"; max_category="5" ;;
    6) resize=",w_272,h_153,c_fill,g_auto";  min_category="6"; max_category="6" ;;
    7) resize=",w_272,h_153,c_fill,g_auto";  min_category="7"; max_category="7" ;;
    8) resize=",w_272,h_153,c_fill,g_auto";  min_category="8"; max_category="8" ;;
  ...
  case ${category} in
    ...
    9)  image_source="cinematile.txt";    image_picon="sports.png" ;;
   10)  image_source="storetile.txt";    image_picon="sports.png" ;;
  esac
  ...
  if [ -s "${workdir}/${image_source}" ]; then
    ...
    if wget -q $(echo ${link} | sed "s/f_png/f_png${resize}/g") -O "${screenpath}/toppicks${image_no}.$$"; then
